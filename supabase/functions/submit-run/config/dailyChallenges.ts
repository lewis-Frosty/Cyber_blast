...
// Copied from src/config/dailyChallenges.ts by scripts/build-edge-shared.mjs so the Edge Function
// runs the SAME logic as the client. Edit the source, then re-run the script.

import { GAMEPLAY_CONFIG, type GameplayConfig } from './gameplay.ts';
